import 'package:meprop_asset_tracker/pages/changelog_page.dart';
...
import 'package:meprop_asset_tracker/settings/settings_page.dart';
import 'package:meprop_asset_tracker/pages/realtokens_page.dart';
import 'package:meprop_asset_tracker/about.dart';
import 'package:meprop_asset_tracker/pages/updates_page.dart';
import 'package:meprop_asset_tracker/pages/realt_page.dart';
import 'package:meprop_asset_tracker/generated/l10n.dart';
import 'package:meprop_asset_tracker/settings/manage_evm_addresses_page.dart';
import 'package:meprop_asset_tracker/app_state.dart';
import 'package:meprop_asset_tracker/components/drawer_menu_factory.dart';
...
import 'package:meprop_asset_tracker/pages/tools_page.dart';
                        ...
                        child: Column(
                          children: [
                            ...
                            DrawerMenuFactory.buildMenuSection(
                              context: context,
                              title: S.of(context).drawerAccounts,
                              appState: appState,
                              items: [
                            ...
                            DrawerMenuFactory.buildMenuSection(
                              context: context,
                              title: S.of(context).drawerFeatures,
                              appState: appState,
                              items: [
                                DrawerMenuFactory.createPageNavItem(
                                  context: context,
                            ...
                            DrawerMenuFactory.buildMenuSection(
                              context: context,
                              title: S.of(context).drawerSupportAndSettings,
                              appState: appState,
                              items: [
                                DrawerMenuFactory.createPageNavItem(
                                  context: context,
