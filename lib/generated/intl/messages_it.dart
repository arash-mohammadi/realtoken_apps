...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(error) => "Errore: ${error}";

  static String m1(language) => "Lingua aggiornata a ${language}";

  static String m2(weeks) => "ROI: ${weeks} settimane";

  static String m3(theme) => "Tema aggiornato a ${theme}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "lastRentReceived": MessageLookupByLibrary.simpleMessage(
            "Il tuo ultimo affitto ricevuto ammonta a "),
        "last_update":
            MessageLookupByLibrary.simpleMessage("Ultimo aggiornamento:"),
        ...
        "rentedUnits": MessageLookupByLibrary.simpleMessage("Unità affittate"),
        ...
        "timeBeforeLiquidation": MessageLookupByLibrary.simpleMessage(
            "Tempo prima della liquidazione"),
