...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(language) => "Language updated to ${language}";

  static String m2(weeks) => "ROI: ${weeks} weeks";

  static String m3(theme) => "Theme updated to ${theme}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "timeBeforeLiquidation":
            MessageLookupByLibrary.simpleMessage("Time before liquidation"),
